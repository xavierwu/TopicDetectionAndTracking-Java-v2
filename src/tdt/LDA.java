...
//	private double DELTA = 0.0;
	...
	private int[][] topics_of_matrix = null; // the topics for each token corresponding to matrix;
	private int[][] word_topic_matrix = null; // num_of_unique_words * num_of_topics
	private double[][] prob_topic_word_matrix = null; // num_of_topics x num_of_unique_words
//	private double[] similarities = null;
	private double[] prob_of_topics = null; // the probability array for each topic over all topics
	...
	/** Extracting topics
	 */
	public void train(int numOfTopics, 
					int numOfIterations, 
					double LAMBDA, 
//					double DELTA, 
					double ALPHA, 
...
//		similarities = new double[corpus.size()];
		words_of_matrix = new int[corpus.size()][];									// [storyID][wordIndexOfTheStory] = wordID(glossary)
		...
		System.out.println("Reading matrix done.");
	...
	/**
	 * Gibbs sampling
	 * Set topics_of_matrix[][]
	 * Set word_topic_matrix[,], document_topic_matrix[,]
	 */
